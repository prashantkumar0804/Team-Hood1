...
public class Get_Create_company extends AsyncTask<String , Integer, Void>{

	String auth1,auth2,username,company_name,responseBody;
	Context ctx;
	...
	public Get_Create_company(Context ctx,ProgressDialog bar, String username,String company_name, SharedPreferences sp) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			HttpPost httppost = new HttpPost(Constant_URL.Create_company);
