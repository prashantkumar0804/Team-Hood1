...
public class Get_Time_bomb_message extends AsyncTask<String , Integer, Void>{
	...
	public Get_Time_bomb_message(Context ctx,ProgressDialog bar, String username,String company_id,String team_id,String message,String sending_time,String sender_email, SharedPreferences sp) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			...
			HttpPost httppost = new HttpPost(Constant_URL.Time_Bomb_Message);
