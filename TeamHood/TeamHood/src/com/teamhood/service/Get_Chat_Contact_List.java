...
public class Get_Chat_Contact_List extends AsyncTask<String , Integer, Void>{
	...
	public Get_Chat_Contact_List(Context ctx,String username,String company_id, String Team_id, ProgressDialog bar, SharedPreferences sp,int w,int h,ListView team_member_list_team_name_list) {
			...
			if(object.has("message")){
				if(object.getString("message").equalsIgnoreCase("OK")){
					...
					if(str1.trim().equalsIgnoreCase("\"No record found in this team.\""))
					{
						...
						Team_Member_List.Member_List_arrayList=new ArrayList<Member_List_Model>();
						for(int i=0;i<str2.length;i++){
							...
							Member_List_adp=new Chat_Contact_List_Adapter(ctx, Team_Member_List.Member_List_arrayList,w,h,sp);
