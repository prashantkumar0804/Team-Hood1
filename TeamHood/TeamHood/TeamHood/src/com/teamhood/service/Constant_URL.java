...
public class Constant_URL {
	...
	public static String chat_conversion="http://teamhood.applifytech.com/index.php/chat_conversion";
	public static String chat_message_send="http://teamhood.applifytech.com/index.php/chat_message_send";
	public static String last_chat_message="http://teamhood.applifytech.com/index.php/last_chat_message";
